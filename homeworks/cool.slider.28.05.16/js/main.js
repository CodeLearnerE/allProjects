...
var a=1;
var myClass=["news1 a","news2 a","news3 a","news4 a","news5 a","news6 a","news7 a","news8 a","news9 a","news10 a"];


$(".fa-angle-up").click(function() {

  	if (a<=myClass.length && a>=1) {
  		myClass.pop();
 	...
 	return a=myClass.length;
 }
  return a-=1;

});
setInterval('$(".fa-angle-down").click()', 1000);
